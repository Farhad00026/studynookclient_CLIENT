      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          ...
          <p className="mt-4 max-w-xl">
            Study Nook Room around the univercity.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="hover:text-white cursor-pointer"> Booked Rooms</li>
              <li className="hover:text-white cursor-pointer"> All Rooms</li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">
            © 2026 StudyNock. All rights reserved.
          </p>
